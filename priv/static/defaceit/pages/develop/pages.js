...
setTimeout(function(){
		var myThumbnails = new Thumbnails({'id': 'thumbnails'},{url:"http://eservices.sandbox.defaceit.ru/variable/pack_json/thumbnails.test.babywonder.ru"}),
			myScripts = new Scripts({'id': 'scripts'},{url:"http://eservices.sandbox.defaceit.ru/variable/pack_json/scripts.test.sandbox.defaceit.ru"}),
			myArticle = new Article({'id':'article.test.babywonder.ru'}),
			template = new Defaceit.Model({id: "edit_page_widget.template.sandbox.defaceit.ru"});
